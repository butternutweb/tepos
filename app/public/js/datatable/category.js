    ...
    var run = function () {
        ...
        var options = {
            data: {
                ...
                source: {
                    read: {
                        url: 'http://localhost:8000/category/ajax',
                        method: 'post',
                        headers: {
            ...
            columns: [{
                ...
                template: function (row) {
                    return '<a class="m-link" href="/account/' + row.owner_id + '">' + row.owner + "</a>";
                }
            }, {
                field: "Actions",
                title: "Actions",
        ...
        $('#m_form_category_owner').on('change', function () {
            var query = datatable.getDataSourceQuery();
        ...
        $('#m_form_category_owner').selectpicker();
