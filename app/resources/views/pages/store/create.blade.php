...
<div class="m-portlet m-portlet--mobile">
    @if (Auth::user()->child()->first() instanceof \App\Admin)
        <form id="m_admin_store" action="{{ route('store.store') }}" method="post" class="m-form m-form--label-align-right">
    @elseif (Auth::user()->child()->first() instanceof \App\Owner)
        <form id="m_owner_store" action="{{ route('store.store') }}" method="post" class="m-form m-form--label-align-right">
    @endif
