...
<div class="m-portlet m-portlet--mobile">
    <form id="m_store_product" action="{{ route('store_.product.store', $store_id) }}" method="post" class="m-form m-form--label-align-right">
            ...
            <div class="form-group m-form__group row {{ $errors->first('selling_price') ? 'has-danger' : '' }}">
                ...
                <div class="col-lg-6">
                    <div class="input-group">
                        ...
                        <input type="text" name="selling_price" class="form-control m-input" placeholder="Enter selling price" value="{{ old('selling_price') }}" aria-describedby="selling_price-error">
                    </div>
