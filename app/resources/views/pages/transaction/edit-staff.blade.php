                            ...
                            <div class="col-border-item">
                                ...
                                <div class="m-bootstrap-touchspin-brand" style="margin-top: 25px">
                                    <div class="input-group bootstrap-touchspin">
                                        <input type="text" class="m_touchspin form-control" value="{{ session('_product_id_' . $product->id) ? session('_product_id_' . $product->id) : ($transaction->products()->where('product.id', $product->id)->first() ? $transaction->products()->where('product.id', $product->id)->first()->pivot->qty : 0) }}" name="demo1" style="display: block;" readonly>
