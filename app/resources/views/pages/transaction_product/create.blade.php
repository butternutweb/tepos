...
<div class="m-portlet m-portlet--mobile">
    <form id="m_transaction_product" action="{{ route('transaction_.product.store', $transaction_id) }}" method="post" class="m-form m-form--label-align-right">
        <div class="m-portlet__body">
            <div class="form-group m-form__group row {{ $errors->first('qty') ? 'has-danger' : '' }}">
                ...
                <div class="col-lg-6">
                    <input type="number" name="qty" class="form-control m-input" placeholder="Enter quantity" value="{{ old('qty') }}" aria-describedby="qty-error">
