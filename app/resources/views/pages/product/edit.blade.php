...
<div class="m-portlet m-portlet--mobile">
    <form id="m_product" action="{{ route('product.update', $product->id) }}" method="post" class="m-form m-form--label-align-right">
        <div class="m-portlet__body">
            <div class="form-group m-form__group row {{ $errors->first('name') ? 'has-danger' : '' }}">
                ...
                <div class="col-lg-6">
                    <input type="text" name="name" class="form-control m-input" placeholder="Enter name" value="{{ old('name') ? old('name') : $product->name }}" aria-describedby="name-error">
            ...
            <div class="form-group m-form__group row {{ $errors->first('sku') ? 'has-danger' : '' }}">
                ...
                <div class="col-lg-6">
                    <input type="text" name="sku" class="form-control m-input" placeholder="Enter SKU" value="{{ old('sku') ? old('sku') : $product->sku }}" aria-describedby="sku-error">
            ...
            <div class="form-group m-form__group row {{ $errors->first('note') ? 'has-danger' : '' }}">
                ...
                <div class="col-lg-6">
                    <input type="text" name="note" class="form-control m-input" placeholder="Enter note" value="{{ old('note') ? old('note') : $product->note }}" aria-describedby="note-error">
            ...
            <div class="form-group m-form__group row {{ $errors->first('capital_price') ? 'has-danger' : '' }}">
                ...
                <div class="col-lg-6">
                    <div class="input-group">
                        ...
                        <input type="number" name="capital_price" class="form-control m-input" placeholder="Enter capital price" value="{{ old('capital_price') ? old('capital_price') : $product->capital_price }}" aria-describedby="capital_price-error">
                    </div>
                    ...
                    <div class="m-form__control">
                        <select class="form-control" name="sub_category_id" aria-describedby="sub_category_id-error">
                            @foreach ($sub_categories as $sub_category)
                                <option value="{{ $sub_category->id }}" {{ old('sub_category_id') ? ($sub_category->id == old('sub_category_id') ? 'selected' : '') : ($sub_category->id == $product->sub_category_id ? 'selected' : '') }}>
