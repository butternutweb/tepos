...
<div class="m-portlet m-portlet--mobile">
    <form id="m_cost" action="{{ route('cost.store', $store_id) }}" method="post" class="m-form m-form--label-align-right">
            ...
            <div class="form-group m-form__group row {{ $errors->first('amount') ? 'has-danger' : '' }}">
                ...
                <div class="col-lg-6">
                    <div class="input-group m-input-group">
                        ...
                        <input type="number" name="amount" class="form-control m-input" placeholder="Enter amount" value="{{ old('amount') }}" aria-describedby="amount-error">
                    </div>
